...
export default interface Castor {
    ...
    createPrismDID(masterPublicKey: PublicKey, services?: DIDDocumentService[]): Promise<DID>;
    createPeerDID(keyPairs: KeyPair[], services: DIDDocumentService[]): Promise<DID>;
